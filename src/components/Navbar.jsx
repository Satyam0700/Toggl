...
const Navbar = () => {
  ...
  return (
    <nav className={`${active && 'border-b-2 border-b-[#493555]' } top-0 z-40 w-full flex bg-[#2C1338] sticky bg-[#FF3F2] py-6 justify-between items-center px-4 sm:px-16`}>
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        <div
          className={`${
            toggle ? "flex" : "hidden"
          } p-6 bg-[#493555] absolute top-20 right-0 mx-4 my-2 min-w-[140px] rounded-xl sidebar`}
        >
